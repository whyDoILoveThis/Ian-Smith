...
export const LINKS = [
    { name: "About Me", href: "/about-me", tagline: "My skills and who I am", target: "_blank" },
   // { name: "Blogs", href: LINK_MY_BLOGS, tagline: "Read my latest blog posts", target: "_blank" },
    ...
    { name: "KwikMaps", href: "/kwikmaps", tagline: "Create efficient routes with AI", target: "_blank" },
    { name: "Google Search", href: "https://google.com", tagline: "Quickly get to the google search bar", target: "_blank" },
