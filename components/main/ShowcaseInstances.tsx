...
const WATER_SORT_EMOJIS = [
  <EmojiText key="1">🍎</EmojiText>,
  <EmojiText key="2">🍊</EmojiText>,
  <EmojiText key="3">🍋</EmojiText>,
  <EmojiText key="4">🥝</EmojiText>,
  <EmojiText key="5">🫐</EmojiText>,
  <EmojiText key="6">🍇</EmojiText>,
  <EmojiText key="7">🍑</EmojiText>,
  <EmojiText key="8">🍓</EmojiText>,
  <EmojiText key="9">🌹</EmojiText>,
  <EmojiText key="10">💎</EmojiText>,
  <EmojiText key="11">🦋</EmojiText>,
  <EmojiText key="12">🐸</EmojiText>,
  <EmojiText key="13">🍒</EmojiText>,
  <EmojiText key="14">🍉</EmojiText>,
  <EmojiText key="15">💜</EmojiText>,
  <EmojiText key="16">🧁</EmojiText>,
];

const ICON_CREATOR_EMOJIS = [
  <EmojiText key="1">🖼️</EmojiText>,
  <EmojiText key="2">🎨</EmojiText>,
  <EmojiText key="3">✂️</EmojiText>,
  <EmojiText key="4">📐</EmojiText>,
  <EmojiText key="5">🔲</EmojiText>,
  <EmojiText key="6">💎</EmojiText>,
  <EmojiText key="7">⬛</EmojiText>,
  <EmojiText key="8">🟧</EmojiText>,
  <EmojiText key="9">🪄</EmojiText>,
  <EmojiText key="10">🖌️</EmojiText>,
  <EmojiText key="11">📸</EmojiText>,
  <EmojiText key="12">🌟</EmojiText>,
  <EmojiText key="13">🔶</EmojiText>,
  <EmojiText key="14">✨</EmojiText>,
  <EmojiText key="15">🎯</EmojiText>,
  <EmojiText key="16">🗂️</EmojiText>,
];
